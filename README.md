這是一份為你的 GitHub 專案量身打造的 `README.md`。

這份文檔已經幫你整理了：

1.  **專案簡介**：清楚說明這是針對國泰世華信件的自動記帳工具。
2.  **功能亮點**：包含你辛苦寫出來的倒序插入、自動排序、iOS 捷徑整合。
3.  **安裝教學**：一步步教人怎麼部署。
4.  **iOS 捷徑設定**：這是最關鍵的，我把 JSON 格式範例都寫好了。

你可以直接複製下方的程式碼區塊，貼到你 GitHub 專案的 `README.md` 檔案中。
